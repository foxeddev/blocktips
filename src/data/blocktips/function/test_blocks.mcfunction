if block ~ ~ ~ #blocktips:has_tips:
    unless entity @e[type=text_display,tag=blocktips.display,distance=..0.5]:
        summon text_display ~ ~ ~ {billboard:"center",Tags:["blocktips.display"],brightness:{sky:15,block:0},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1f,1f],scale:[1f,1f,1f]}}
