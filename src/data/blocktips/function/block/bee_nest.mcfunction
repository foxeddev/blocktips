if block ~ ~ ~ bee_nest:
    ...
    if block ~ ~ ~ bee_nest[honey_level=0] run data modify entity @s data.blocktips.honey_level set value "0"
    if block ~ ~ ~ bee_nest[honey_level=1] run data modify entity @s data.blocktips.honey_level set value "1"
    if block ~ ~ ~ bee_nest[honey_level=2] run data modify entity @s data.blocktips.honey_level set value "2"
    if block ~ ~ ~ bee_nest[honey_level=3] run data modify entity @s data.blocktips.honey_level set value "3"
    if block ~ ~ ~ bee_nest[honey_level=4] run data modify entity @s data.blocktips.honey_level set value "4"
    if block ~ ~ ~ bee_nest[honey_level=5] run data modify entity @s data.blocktips.honey_level set value "5"

    if data entity @s data.blocktips.bees:
        scoreboard players set #bees temp 0
        function ./bee_nest/loop:
